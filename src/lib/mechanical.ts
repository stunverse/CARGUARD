...
export const MECHANICAL_POINTS: MechanicalPoint[] = [
  ...
  {
    code: "idle_noise",
    title: "Idle engine noise (sound)",
    order_index: 8,
    media_type: "audio",
    required: true,
    instruction: "Record 20–30s of the engine at idle with the hood open. A sound recording is enough — no video or photo. Phone steady, no music.",
    why_it_matters:
      "Noises that grow with revs, loud knocking when hot, or an unstable idle point to mechanical wear.",
    ai_targets: [
      "knocking_or_metallic_noise",
      "rubbing_or_whistling",
      "belt_squeal",
      "unstable_idle_sound",
    ],
    observations: [
  ...
  // ----- Optional -----
  {
    ...
    observations: [
      { key: "power_loss", label: "Power loss / car feels sluggish", kind: "suspect", weight: 22 },
      { key: "jerks", label: "Jerks or hesitation", kind: "suspect", weight: 20 },
      { key: "warning_light_appears", label: "A warning light appeared while driving", kind: "suspect", weight: 28 },
      { key: "temp_or_smell", label: "Temperature rose abnormally or burning smell", kind: "suspect", weight: 26 },
      { key: "all_good", label: "Drove well, nothing abnormal", kind: "good", weight: 0 },
    ],
  },
  {
